        ...
        return (
          <FormItem>
            <div className="relative">
              ...
              <span
                className={cn(
                  'text-muted-foreground pointer-events-none absolute top-1/2 -translate-y-1/2 text-sm transition-[top,left,transform,padding,background-color,color] duration-200',
                  Icon ? 'left-9' : 'left-3',
